...
for proj in proj_dict:
    ...
    if stud_id[0] == "A":
        student_grade = id_gr_dict[stud_id]["GRADE"]
        student_name = id_gr_dict[stud_id]["STUDENT NAME"]
    else:
        stud_id = stud_id.lower()
        student_grade = net_gr_dict[stud_id]["GRADE"]
        student_name = net_gr_dict[stud_id]["STUDENT NAME"]
    proj_dict[proj]["grade"] = student_grade
